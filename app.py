...
# Só mostrar modelos e botão depois que arquivo for carregado
if arquivo:
    ...
    if not texto:
        ...
        if st.button("Gerar Estratégia"):
            with st.spinner("Chamando a IA..."):
                ...
                prompt = "Você é especialista em marketing digital. Crie uma estratégia baseada no texto abaixo:\n\n" + texto[:3000]
